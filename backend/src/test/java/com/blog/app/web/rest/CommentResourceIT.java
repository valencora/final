...
class CommentResourceIT {
    ...
    public static Comment createEntity() {
        return new Comment().text(DEFAULT_TEXT).date(DEFAULT_DATE);
    }
    ...
    public static Comment createUpdatedEntity() {
        return new Comment().text(UPDATED_TEXT).date(UPDATED_DATE);
    }
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.text(UPDATED_TEXT).date(UPDATED_DATE);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.text(UPDATED_TEXT).date(UPDATED_DATE);
