...
import static com.blog.app.web.rest.TestUtil.createUpdateProxyForBean;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.blog.app.IntegrationTest;
...
class BlogResourceIT {
    ...
    public static Blog createEntity() {
        return new Blog().name(DEFAULT_NAME).handle(DEFAULT_HANDLE).description(DEFAULT_DESCRIPTION);
    }
    ...
    public static Blog createUpdatedEntity() {
        return new Blog().name(UPDATED_NAME).handle(UPDATED_HANDLE).description(UPDATED_DESCRIPTION);
    }
    ...
    void putExistingBlog() throws Exception {
        ...
        updatedBlog.name(UPDATED_NAME).handle(UPDATED_HANDLE).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateBlogWithPatch() throws Exception {
        ...
        partialUpdatedBlog.name(UPDATED_NAME).handle(UPDATED_HANDLE).description(UPDATED_DESCRIPTION);
